...
class Handorgel {
  ...
  update() {
    ...
    for (let i = 0, childrenLength = children.length; i < childrenLength; i = i + 2) {
      ...
      const content = children[i + 1]; // get fold instance if there is already one

      let fold = header.handorgelFold; // create new one when header and content exist
